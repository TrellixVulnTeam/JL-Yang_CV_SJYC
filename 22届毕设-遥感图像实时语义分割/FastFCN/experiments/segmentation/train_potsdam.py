...
class Trainer():
    def __init__(self, gpu, ngpus_per_node, args):
        ...
        if args.cuda:
            ...
            self.model = nn.parallel.DistributedDataParallel(self.model.cuda(), device_ids=[self.gpu],
    ...
    def training(self, epoch):
        ...
        self.train_loss = train_loss / len(tbar)
    ...
    def validation(self, epoch):
        ...
        def eval_batch(model, image, target):
            ...
            self.val_loss = self.criterion(outputs, target)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(trainer.args.start_epoch, trainer.args.epochs):
        ...
        writer.add_scalar("Loss/train", trainer.train_loss, epoch)
        if not trainer.args.no_val:
            trainer.validation(epoch)
            writer.add_scalars("Loss/train & val", {"train": trainer.train_loss, "val": trainer.val_loss}, epoch)
